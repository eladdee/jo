...
.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationWrapper) {
    height: 7.5rem
}

.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationBar),.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationButton) {
    background: #151516
}

.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationPrimaryItemImgWrapper),.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationSecondaryItemImgWrapper) {
    display: flex;
    flex-direction: column;
    justify-content: center
}

.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationButton NavigationButtonActive):before {
    content: none
}

.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationWindow NavigationWindowOpened) {
    border-bottom: none;
    box-sizing: border-box
}

.MobileBottomNavigationWrapper mobile-bottom-navigation::part(NavigationWindowTitle) {
    display: none
}
