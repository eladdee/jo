<section class="SectionContent ">
               <div class="SportsIframeWrapper">
                  ...
                  <iframe id="SportsIframe" scrolling="no" class="SportsIframe" title="Sports Iframe" src="/iframe2.php" allow="autoplay;fullscreen;web-share" style="height: 3196px;"></iframe>
               </div>
               <div class="GameCategoriesWrapper">
                  ...
                  <section id="Jojobet-anasayfa$türkçe-casino" class="CasinoGames GamesList GamesListGrid MsnRow" data-subcategories-status="NOT_STARTED">
                     ...
                     <div class="GamesSwipeable">
                        <div class="GamesWrapper VerticalMobileLayout">
                           <ul class="GamesListContainer HorizontalScrollBar HasLoadMoreButton List ListUnordered ">
                              <li class="ListGame ListItem GameContainerDimmed" data-game-id="33198055936">
                                 <div class="ListGameLink Anchor">
                                    <div class="ComponentGameThumbnail GameThumbContainer FrameGameThumbnail">
               ...
               <bannermatrix-banner operator-id="1990" webapi-url="wss://sportsapi.jojobet994.com/v2" webapi-realm="www.jojobet.com" language="tr" demo="false" page-tag="home-page" position-tag="center-bottom" translate="{}" em-user-roles="[]" logged-in="false"></bannermatrix-banner>
               <bannermatrix-banner operator-id="1990" webapi-url="wss://sportsapi.jojobet994.com/v2" webapi-realm="www.jojobet.com" language="tr" demo="false" page-tag="home-page" position-tag="center-popup" translate="{}" em-user-roles="[]" logged-in="false"></bannermatrix-banner>
               <bannermatrix-banner operator-id="1990" webapi-url="wss://sportsapi.jojobet994.com/v2" webapi-realm="www.jojobet.com" language="tr" demo="false" banner-type="streaming" sportbook-id="SportsIframe" translate="{}" em-user-roles="[]" logged-in="false"></bannermatrix-banner>
</section>