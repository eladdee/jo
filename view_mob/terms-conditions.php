<section class="SectionContent ">
   <div class="ContentWrapper TextPageWrapper ComponentLayout Layout CmsStaticPage">
      <span id="ch_1141585412" class="">
         ...
         <p>1.1. Web sitemiz Jojobet.com (“Website”) ‘u kullanarak, ziyaret ederek veya üye olarak aşağıdaki maddeleri kabul etmiş sayılırsınız:</p>
         ...
         <p>2.1. Jojobet.com, Curacao devleti tarafından regüle edilmektedir. This Service operates under the License No. 8048/JAZ issued to Antillephone, Authorized and Regulated by the Government of Curacao.</p>
         ...
         <ol start="4">
            <li><strong> Hesap Açma</strong></li>
         </ol>
         ...
         <p>4.7. Başka bir hesap açmak istiyorsanız geçerli sebeplerinizi yazılı olarak info@jojobet.com mail adresimize göndermeniz gerekmektedir. Yeni hesap açmak istemenizin sebebinin geçerli olduğu sonucuna varılırsa eski hesap kapatıldıktan sonra yeni hesap açmanıza izin verilir.</p>
         <p>4.8. Hesap bilgilerinizi korumalı ve güncel tutmalısınız.</p>
         <ol start="5">
            <li><strong> Kimlik Doğrulama ve Karapara Önleme Politikası</strong></li>
         </ol>
         ...
         <ol start="7">
            <li><strong> Hesabınıza Para Yatırma ve Hesabınızdan Para Çekme</strong></li>
         </ol>
         ...
         <p>8.3. Tek kupondan maksimum kazanç 5.000.000₺’dir. (Spor bahisi, casino, canlı casino oyunları, sanal bahisler ve tv oyunları bu kurala dahildir.)</p>
         <p>8.4. Bir bahis onaylandıktan sonra yazılı iznimiz olmadan işlem iptal edilemez.</p>
         <ol start="9">
            <li><strong><br>
               Gizli anlaşma, Hile, Dolandırıcılık Ve Yasadışı Faaliyetler</strong>
            </li>
         </ol>
         <p>9.1. Aşağıdaki aktiviteler sitemiz üzerinde yasaktır.</p>
         <ol>
            <li>a) Üçüncü şahıslarla gizli anlaşmalar yapmak.</li>
            <li>b) Adaletsizlik yaratacak bir üstünlük veya etki kullanmak (genel tabiriyle hile yapmak), olası bir hatanın istismarı, yazılım açığı veya hatalarını kullanmak, otomatik oyuncular kullanmak (‘bots’ olarak da adlandırılır).</li>
            <li>c) Dolandırıcılık yöntemi ile ele geçirilmiş, çalınmış, kopyalanmış kredi veya debit kartlarını kullanmak, kara para aklama veya benzeri suçların içerisinde yer almak veya bir parçası olmak.</li>
         </ol>
         ...
         <ol start="10">
            <li><strong><br>
               Diğer Yasaklı Faaliyetler</strong>
            </li>
         </ol>
         ...
         <ol start="11">
            <li><strong><br>
               Hesap Kapatma ve Feshetme</strong>
            </li>
         </ol>
         ...
         <p>11.2. Hesap kapatma taleplerinizi ; hesap kapatma nedeniniz ile beraber ”info@jojobet.com” mail adresimize gönderim sağlayarak gerçekleştirebilirsiniz. Talebiniz işleme alındıktan sonra 60 iş günü içerisinde aktif olmamanız halinde hesabınız askıya alınacaktır.</p>
         ...
         <ol start="12">
            <li><strong><strong><br>
               Website Güncellemeleri</strong></strong>
            </li>
         </ol>
         ...
         <ol start="13">
            <li><strong><br>
               Bilgi Teknolojileri Hataları</strong>
            </li>
         </ol>
         ...
         <p>14.2. Jojobet.com yanlış bahis oranları, değişmiş oranlar(oranların yanlış takımların karşısında listelendiği) veya canlı bahis oynanabilir olmadığı zamanda yapılmış bahisleri iptal etme hakkını saklı tutar. Jojobet.com herhangi bir bahisi iptal etme, kısıtlama, reddetme ve sınırlama hakkını saklı tutar.</p>
         ...
         <ol start="16">
            <li><strong><br>
               Kullanım Koşulları İhlalleri</strong>
            </li>
         </ol>
         ...
         <ol start="20">
            <li><strong><br>
               Şikayetler ve Bildirimler</strong>
            </li>
         </ol>
         ...
         <ol start="22">
            <li><strong><br>
               Hakların ve Yükümlülüklerin Devri</strong>
            </li>
         </ol>
         ...
         <ol start="23">
            <li><strong><br>
               Kontrolümüz Dışındaki Olaylar</strong>
            </li>
         </ol>
         ...
         <ol start="33">
            <li><strong><br>
               Düzenlenmiş Bölgeler (yalnızca NetEnt tarafından görülen ve onaylanan yerel düzenleyiciden bir lisans alınması durumunda teklif verilmelidir)</strong>
            </li>
         </ol>
         ...
         <ol start="35">
            <li><strong><br>
               Hizmetlerin kullanımı yalnızca eğlence amaçlıdır: profesyonel oyun yasaktır.</strong>
            </li>
         </ol>
         ...
         <ol start="37">
            <li><strong><br>
               Yapılan her yatırım ile ilgili beyan</strong>
            </li>
         </ol>
         ...
         <ol start="40">
            <li><strong> Günlük maksimum kazanç.</strong></li>
         </ol>
         ...
         <ol start="41">
            <li><strong>Yatırım ve çekim işlemlerinin aynı ödeme yöntemi ile yapılması</strong></li>
         </ol>
         ...
         <ol start="43">
            <li><strong>Günlük para çekme limiti ve yöntem başına çekilebilecek en yüksek miktar</strong></li>
         </ol>
         ...
         <ol start="45">
            <li><strong>Şikayetler, uyuşmazlıklar ve alternatif uyuşmazlık çözümleri</strong></li>
         </ol>
         ...
         <p><strong>Sorumlu Oyun ve Bahis</strong><br>
            Jojobet olarak, bizimle oynamayi seçen her bireyin sagligini önemsiyoruz.<br>
            Amacimiz, tüm kullanicilar için güvenli ve keyifli bir deneyim sunmak ve dengeli ve saglikli bir oyun süreci saglamaniza destek olmaktir.<br>
            Lütfen sorumlu bir sekilde oynadiginizi unutmayin ve eger kumar bir zorluk haline gelirse destek aramaktan çekinmeyin.<br>
            <strong>Yas Politikasi</strong><br>
            Jojobet olarak, bizimle oynamayi seçen her bireyin sagligini önemsiyoruz.<br>
            Amacimiz, tüm kullanicilar için güvenli ve keyifli bir deneyim sunmak ve dengeli ve saglikli bir oyun süreci saglamaniza destek olmaktir.<br>
            Lütfen sorumlu bir sekilde oynadiginizi unutmayin ve eger kumar bir zorluk haline gelirse destek aramaktan çekinmeyin.<br>
            <strong>Kendi Kendine Kisitlama Politikasi</strong><br>
            Bahis faaliyetlerinizi sinirlamak isterseniz, istege bagli olarak sunulan kendi kendine kisitlama politikamizdan yararlanabilirsiniz. Bu, hesabinizi kapatmaniza veya bahislerinize limit koymaniza olanak tanir. Bu hizmete erismek için lütfen müsteri hizmetleri ekibimizle iletisime geçin.<br>
            Bu kendini sinirlama hizmetini kullanmaniza yardimci olmak için elimizden geleni yapacagiz; ancak belirlediginiz limitlerin ötesinde bahis yapma girisimlerinizi tespit edemememiz durumunda sorumluluk kabul edilmemektedir.<br>
            Sizin iyiliginiz bizim önceligimizdir ve sorumlu oyun uygulamalarini destekleme konusunda kararliyiz.<br>
            <strong>Güvenli Kumar Için Yardim ve Destek</strong><br>
            Jojobet olarak sorumlu kumar oynamayi tesvik etmeye kararliyiz. Kullanicilarimizin deneyimlerinden güvenli ve sorumlu bir sekilde keyif almasini istiyoruz. Kumarin bir sorun haline geldigini düsünüyorsaniz veya ara vermek istiyorsaniz, destek almanizi tavsiye ederiz.<br>
            <strong>Türkiye’de kumar bağımlılığı konusunda destek saglayan kuruluş:</strong><br>
            <strong>Yesilay (Green Crescent):</strong> Türkiye’nin bagimlilik tedavisi ve destegi saglayan ana kurulusudur. Yardim almak için Yesilay’i ziyaret edin.<br>
            <strong>iletisim Bilgileri:</strong><br>
            <strong>• Yardim Hatti:</strong> 444 79 75<br>
            <strong>• Web Sitesi:</strong> Yesilay – Kumar Bagimliligi Destegi<br>
            Ek olarak, <strong>Jojobet</strong>, daha fazla destek için güvenilir kuruluslarla is birligi yapmaktadir:<br>
            <strong>GamCare</strong><br>
            <strong>• Web Sitesi:</strong> www.gamcare.org.uk<br>
            <strong>• E-posta:</strong> info@gamcare.org.uk<br>
            <strong>• Yardim Hatti:</strong> (+44) 808 802 0133<br>
            <strong>GambleAware</strong><br>
            <strong>• Web Sitesi:</strong> www.begambleaware.org<br>
            <strong>• E-posta:</strong> help@begambleaware.org<br>
            <strong>• Yardim Hatti:</strong> +44 800 8020 133 (Ücretsiz)<br>
            <strong>Gambling Therapy</strong><br>
            <strong>• Web Sitesi:</strong> https://www.gamblingtherapy.org/<br>
            <strong>• E-posta:</strong> help@gamblingtherapy.org<br>
            <strong>• Yardim Hatti:</strong> +44 1384 241292
         </p>
      </span>
      <span></span>
   </div>
